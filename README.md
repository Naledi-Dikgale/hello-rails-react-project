...
**[Hello rails-react-project]** Is an app that fetches and displays random greetings.
...
```
  ...
  git clone https://github.com/Naledi-Dikgale/hello-rails-react-project.git
```
...
- Website: [https://naledi.netlify.app/]
...
Feel free to check the [issues page](https://github.com/Naledi-Dikgale/hello-rails-react-project/issues).
